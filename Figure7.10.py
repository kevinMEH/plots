...
figure, axes = default.getFigureAxes(left=0, right=1.2, top=4.5, bottom=0, bottomArrow=False)
...
axes.plot(np.linspace(1, 1, 50), np.linspace(0, 4.5, 50), zorder=-10, alpha=0.2, color="k")
axes.set_xticks(np.linspace(0.2, 1.0, 5))
axes.set_yticks(np.linspace(0, 4, 5))
