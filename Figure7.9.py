...
figure, axes = default.getFigureAxes(left=-75, right=0, rightLim=5, top=25, bottom=-8,
xPosition="left", flipY=True)
...
axes.plot(x, y)
axes.plot(np.linspace(-75, 0, 50), np.linspace(1, 1, 50), zorder=-10, alpha=0.5, color="k")
